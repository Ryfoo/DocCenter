...
function Header() {
    const menuItems = [
        { id: "home", label: "Homepage", to: "/", key: 1 },
        { id: "profile", label: "Profile", to: "/profile", key: 2 },
        { id: "logout", label: "Logout", to: "/login", key: 3 },
    ];
    return (
        <div className="navbar bg-base-100 shadow-sm">
            ...
            <div className="navbar-center">
                <a href="/">
                    <img src="../../public/assets/logo.png" className="w-54 h-28" />
                </a>
            </div>
